1)
-- Bug 1208 (Redmine #20156) Active Calls. Не мьютим System Bridge/Console Patch при мьюте бокса в актив кол (rejected)
2)
...
-- Сделать пример DI в тествой ветке One
3)
4) Хочу в отпуск с 22 июня по 5 июля
