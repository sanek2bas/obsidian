...
-- Bug #1104 (Redmine #19772) Voice Dispatch. Интерком бокс остается в сессии после отжатия PTT кнопки 
	(бага отложена, бага тянется из прошлых версий One, ее не было в списке который высылала Катя, но зато немного посмотрел как на сервере работает и откуда взялась эта бага)
2)
